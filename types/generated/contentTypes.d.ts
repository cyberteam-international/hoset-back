...
export interface ApiCategoryOfProjectCategoryOfProject extends Struct.CollectionTypeSchema {
  collectionName: "category_of_projects";
  info: {
    displayName: "CategoryOfProject";
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::category-of-project.category-of-project"> & Schema.Attribute.Private;
    Name: Schema.Attribute.String;
...
export interface ApiFilterFilter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::filter.filter"> & Schema.Attribute.Private;
...
export interface ApiGeneralGeneral extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::general.general"> & Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
  };
...
export interface ApiLanguageLanguage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    language_name: Schema.Attribute.String;
    language_tag: Schema.Attribute.UID<"language_name"> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    current_language: Schema.Attribute.Relation<"oneToOne", "api::language.language">;
    HomePageButtonText: Schema.Attribute.String & Schema.Attribute.DefaultTo<"Visit now">;
    HomePageLogo: Schema.Attribute.Media<"images" | "files" | "videos" | "audios">;
    HomePageMediaPreview: Schema.Attribute.Media<"images" | "files" | "videos" | "audios">;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    Sections: Schema.Attribute.DynamicZone<
      [
        ...
        "sections.projects-list-section-v2",
      ]
    >;
    SEO: Schema.Attribute.Component<"shared.seo", false>;
    slug: Schema.Attribute.UID<"Title"> & Schema.Attribute.Required;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Characteristics: Schema.Attribute.DynamicZone<["shared.characteristic"]>;
    ...
    publishedAt: Schema.Attribute.DateTime;
    Sizes: Schema.Attribute.DynamicZone<["shared.size"]>;
    slug: Schema.Attribute.UID<"Title"> & Schema.Attribute.Required;
    Title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category_of_projects: Schema.Attribute.Relation<"manyToMany", "api::category-of-project.category-of-project">;
    ColorCode: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    Description: Schema.Attribute.String;
    ...
    MediaPreview: Schema.Attribute.Media<"images" | "files" | "videos" | "audios">;
    publishedAt: Schema.Attribute.DateTime;
    Sections: Schema.Attribute.DynamicZone<
      [
        "sections.video-section",
